...
|Date|Event|Details|
|---|---|---|
|Nov 30|OpenAI|Sam Altman returns as CEO, OpenAI has a new initial board. [Source](https://openai.com/blog/sam-altman-returns-as-ceo-openai-has-a-new-initial-board)|
|Nov 30|ChatGPT|Happy 1st birthday, ChatGPT!|
|Nov 21|Voice|ChatGPT with voice is now available to all free users. [Source](https://twitter.com/OpenAI/status/1727065166188274145)|
|Nov 17|OpenAI|Chief technology officer Mira Murati appointed interim CEO to lead OpenAI; Sam Altman departs the company. [Source](https://openai.com/blog/openai-announces-leadership-transition)|
|Nov 06|GPTs|OpenAI has introduced GPTs, customizable versions of ChatGPT you can tailor for specific tasks and share. Learn how these new AI assistants work. [Source](https://openai.com/blog/introducing-gpts)|
|Nov 06|GPT-4 Turbo|OpenAI Announces GPT-4 Turbo, DALL-E 3 API, Assistants API, and More. [Source](https://openai.com/blog/new-models-and-developer-products-announced-at-devday)|
|Oct 19|DALL-E 3|DALL·E 3 is now available in ChatGPT Plus and Enterprise. [Source](https://openai.com/blog/dall-e-3-is-now-available-in-chatgpt-plus-and-enterprise)|
|Oct 06|DALL-E 3|DALL-E 3 Is Now Available In ChatGPT.|
|Sep 27|Web Search|The web search is back in ChatGPT! [Source](https://twitter.com/OpenAI/status/1707077710047216095)|
|Sep 25|Multimodal|OpenAI is on the brink of releasing revolutionary upgrades to ChatGPT, imbuing it with the capability to perceive and interpret voice and images. [Source](https://openai.com/blog/chatgpt-can-now-see-hear-and-speak)|
|Aug 28|ChatGPT Enterprise|OpenAI Launches ChatGPT Enterprise: A More Powerful and Secure Version of ChatGPT. [Source](https://openai.com/blog/introducing-chatgpt-enterprise)|
|Aug 22|GPT-3.5|OpenAI Opens Up Fine-Tuning for GPT-3.5 Turbo. [Source](https://techcrunch.com/2023/08/22/openai-brings-fine-tuning-to-gpt-3-5-turbo/)|
|Aug 22|ChatGPT|Custom Instructions Are Now Available In The EU & UK. [Source](https://twitter.com/OpenAI/status/1693710060785107223)|
|Aug 08|GPTBot|OpenAI Deploys Web Crawler GPTBot to Train Next-Generation Language Model GPT-5. [Source](https://www.artificialintelligence-news.com/2023/08/08/openai-deploys-web-crawler-preparation-gpt-5/)|
|Aug 03|ChatGPT|Upload multiple files, suggested prompts and replies, and a whole lot more. OpenAI just released a bevy of updates for ChatGPT. [Source](https://twitter.com/OpenAI/status/1687159114047291392)|
|Aug 01|GPT-5|OpenAI has filed a new trademark application for “GPT-5”. [Source](https://www.reddit.com/r/ChatGPT/comments/15egp3n/its_happening_openai_has_filed_a_new_trademark/)|
|July 31|ChatGPT Android|ChatGPT app for Android is now available in all countries and regions. [Source](https://help.openai.com/en/articles/7947663-chatgpt-supported-countries)|
|July 27|ChatGPT Android|The ChatGPT app for Android is now available to users in Argentina, Canada, France, Germany, Indonesia, Ireland, Japan, Mexico, Nigeria, the Philippines, the UK, and South Korea! [Source](https://twitter.com/OpenAI/status/1684582092418711552)|
|July 25|ChatGPT Android|ChatGPT for Android is now available for download in the US, India, Bangladesh, and Brazil. [Source](https://twitter.com/OpenAI/status/1683854695398522881)|
|July 24|AI Classifier Tool|OpenAI Shutters AI Classifier Tool Amid Low Usage and Accuracy Concerns. [Source](https://decrypt.co/149826/openai-quietly-shutters-its-ai-detection-tool)|
|July 21|ChatGPT Android|OpenAI Announced ChatGPT for Android. [Source](https://www.scriptbyai.com/ai-weekly-digest-issue-14/#OpenAI_Announced_ChatGPT_for_Android)|
|July 20|ChatGPT|OpenAI Introduced Custom Instructions for ChatGPT. [Source](https://openai.com/blog/custom-instructions-for-chatgpt)|
|July 19|GPT-4|OpenAI’s doubling the number of messages ChatGPT Plus customers can send to GPT-4. [Source](https://help.openai.com/en/articles/6825453-chatgpt-release-notes)|
|July 06|GPT-4 API|GPT-4 is Now Generally Available: What You Need to Know. [Source](https://openai.com/blog/gpt-4-api-general-availability)|
|July 06|Code Interpreter|Code Interpreter will be available to all ChatGPT Plus users. [Source](https://twitter.com/OpenAI/status/1677015057316872192)|
|July 04|Web Browsing|OpenAI Disables ChatGPT’s Web Browsing Feature Due to Misuse. [Source](https://decrypt.co/147300/openai-disables-web-browse-bing-chatgpt)|
|June 30|ChatGPT iOS app|ChatGPT on iOS Gets a Major Update with Bing Integration. [Source](https://www.theverge.com/2023/6/27/23776006/chatgpt-ios-app-bing-search)|
|June 29|OpenAI|OpenAI Sued for Scraping Private Data to Train ChatGPT. [Source](https://fortune.com/2023/06/28/openai-chatgpt-sued-private-data/)|
|June 21|Credentials Leaked|Over 100,000 ChatGPT Credentials Leaked, Users Urged to Change Passwords. [Source](https://thehackernews.com/2023/06/over-100000-stolen-chatgpt-account.html)|
|June 17|Mercedes-Benz|Mercedes-Benz Brings Human-Like Chatbot to Vehicles with ChatGPT. [Source](https://fortune.com/2023/06/16/mercedes-benz-trial-chatgpt-microsoft-azure-mbux-voice-assistant/)|
